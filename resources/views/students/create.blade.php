...
<form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="card shadow-sm border-0 p-4">
    @csrf

    <div class="row g-3">
        <div class="col-md-4">
            <label class="form-label">Student ID Number</label>
            <input type="text" name="student_id_number" class="form-control" value="{{ old('student_id_number') }}" required>
        </div>
